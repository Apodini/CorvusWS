...
/// authorize.
public class ExtendedNestedAuthModifier<
    A: ExtendedAuthEndpoint,
    I: CorvusModel,
    U: CorvusModelAuthenticatable>:
ExtendedRestModifier<A>, ExtendedAuthEndpoint {
...
extension ExtendedAuthEndpoint {
    ...
    public func auth<I: CorvusModel, U: CorvusModelAuthenticatable> (
        _ intermediate: ExtendedNestedAuthModifier<Self, I, U>.IntermediateKeyPath,
        _ user: ExtendedNestedAuthModifier<Self, I, U>.UserKeyPath
    ) -> ExtendedNestedAuthModifier<Self, I, U> {
        ExtendedNestedAuthModifier(self, intermediate: intermediate, user: user)
    }
}
