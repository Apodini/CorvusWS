...
/// from `ExtendedAuthModifier` by authenticating on the user of an intermediate parent
/// `I` of `A.QuerySubject`. Requires an object `U` that represents the user to
/// authorize.
public final class ExtendedNestedReadAllAuthModifier<
    A: ExtendedAuthEndpoint,
    I: CorvusModel,
    U: CorvusModelAuthenticatable>:
ExtendedReadEndpoint {
    ...
    /// The `ExtendedAuthEndpoint` the `.auth()` modifier is attached to.
...
/// conforming to `ExtendedAuthEndpoint` that allows defining an intermediate type `I`.
extension ExtendedReadAll {
    ...
    public func auth<I: CorvusModel, U: CorvusModelAuthenticatable> (
        _ intermediate: ExtendedNestedReadAllAuthModifier<ExtendedReadAll, I, U>
        .IntermediateKeyPath,
        _ user: ExtendedNestedReadAllAuthModifier<ExtendedReadAll, I, U>.UserKeyPath
    ) -> ExtendedNestedReadAllAuthModifier<ExtendedReadAll, I, U> {
        ExtendedNestedReadAllAuthModifier(self, intermediate: intermediate, user: user)
    }
}
