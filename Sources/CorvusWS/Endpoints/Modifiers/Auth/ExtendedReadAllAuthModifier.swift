...
/// authorize.
public final class ExtendedReadAllAuthModifier<
...
extension ExtendedReadAll {
    ...
    public func auth<U: CorvusModelAuthenticatable> (
        _ user: ExtendedReadAllAuthModifier<ExtendedReadAll, U>.UserKeyPath
    ) -> ExtendedReadAllAuthModifier<ExtendedReadAll, U> {
        ExtendedReadAllAuthModifier(self, user: user)
    }
}
