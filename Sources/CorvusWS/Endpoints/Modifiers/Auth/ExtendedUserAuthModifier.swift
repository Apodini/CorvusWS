...
/// struct conforming to `ExtendedAuthEndpoint`.
public final class ExtendedUserAuthModifier<
...
/// to `ExtendedAuthEndpoint`.
extension ExtendedAuthEndpoint where Self.QuerySubject: CorvusModelAuthenticatable {
    ...
    /// to the user.
    func userAuth() -> ExtendedUserAuthModifier<Self> {
        ExtendedUserAuthModifier(self)
    }
}
