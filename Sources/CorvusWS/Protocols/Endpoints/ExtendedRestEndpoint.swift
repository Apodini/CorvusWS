...
public protocol ExtendedRestEndpoint: ExtendedEndpoint {
...
/// Extends `ExtendedRestEndpoint` with default implementation for route registration.
public extension ExtendedRestEndpoint {
